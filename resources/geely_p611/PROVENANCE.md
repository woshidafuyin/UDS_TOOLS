# Geely P611 flashing resources

P611 intentionally uses the same flashing workflow as P416 while keeping an
...
transfer. The P611 profile points to its own copy under
`resources/geely_p611/ESS/ess_out.VBF`; no reconstructed ESS duplicate is
produced or required.

This is an offline resource and workflow parity statement, not a P611 ECU
